...
function prompt(postalCode: string) {
  return [
    `邮编 ${postalCode} 附近有哪些做食品杂货的超市？`,
    "",
    "要求：",
    "- 只列真实存在、并且现在还在营业的门店，最多 10 家",
    "- 只列会发每周 flyer / weekly specials 的超市，便利店和餐厅不算",
    "- address 用官方写法的完整街道地址，要带门牌号",
    "- flyerUrl 必须是这家连锁官网上真正能看到本店 flyer 的页面，不要给第三方聚合站",
    "- chain 填连锁品牌名（如 Walmart、T&T、Save-On-Foods）；独立超市就填店名",
    "- 拿不准某一家的 flyer 页面就不要列它。列少几家没关系，列错一家会让人白跑一趟",
  ].join("\n");
}
